...
class MarkMuse:
    ...
    def save_images_from_ocr(self, ocr_response: Any, images_dir: str) -> Dict[str, str]:
        """
        从OCR结果中提取并保存图片
    ...
    def create_markdown_from_ocr(self, ocr_response: Any, output_dir: str, filename: str) -> str:
        ...
        # 使用正则表达式替换所有图片链接
        corrected_content = re.sub(r'!\[([^\]]*)\]\(([^)]+)\)', replace_image_link, markdown_content)
